...
DatePicker.defaults = (function( prefix ) {
    ...
    return {
        ...
        // Months and weekdays
        monthsFull: [ 'Yanvar', 'Fevral', 'Mart', 'Aprel', 'May', 'Iyun', 'Iyul', 'Avgust', 'Sentabr', 'Oktyabr', "No'yabr", 'Dekabr' ],
        monthsShort: [ 'Yan', 'Fev', 'Mar', 'Apr', 'May', 'Iyun', 'Iyul', 'Avg', 'Sen', 'Okt', 'Noy', 'Dek' ],
        weekdaysFull: [ 'Dushanba', 'Seshanba', 'Chorshanba', 'Payshanba', 'Juma', 'Shamba', 'Yakshanba' ],
